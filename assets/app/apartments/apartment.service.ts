...
const headers= new Headers({'Content-Type':'application/json'});
 const token = localStorage.getItem('token')
            ...
            : '';
return this.http.post(' https://yelpapartmentss.herokuapp.com/apartment'+token,body,{headers:headers})
...
//Get all Apartments
 getApartments(){
     return this.http.get(' https://yelpapartmentss.herokuapp.com/apartment')
     .map((response:Response)=>{
 ...
 updateApartment(apartment:ApartmentModel){
     ...
     return this.http.patch(' https://yelpapartmentss.herokuapp.com/apartment/'+apartment.apartmentId+token,body,{headers:headers})
 ...
 deleteApartment(apartment:ApartmentModel){
     ...
     const token = localStorage.getItem('token')
            ? '?token=' + localStorage.getItem('token')
            : '';
     return this.http.delete(' https://yelpapartmentss.herokuapp.com/apartment/'+apartment.apartmentId+token)
    .map((response: Response) => response.json())
            .catch((error: Response) => {
                this.errorService.handleError(error.json());
                return Observable.throw(error.json());
